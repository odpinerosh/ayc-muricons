...
const NavLinks = (props) => {
    ...
    return (
        <div className="nav-links" id={props.padre}> 
            ...
            <a href="https://wa.me/+573202172911?text=Quiero%20realizar%20un%20proyecto" target="_blank" onClick={clickMenu} rel="noopener noreferrer" className="nav-link">
                +57 (320) 217-2911
            ...
            <div class="nav-link contact-link">
                <a href='https://docs.google.com/forms/d/1L2qgt5XWoc4Dvs24CMhW22qKeDDuWsZgmOr3HvNt2aA/edit?usp=sharing' className='btn btn-hipster' target="_blank" rel="noopener noreferrer" onClick={clickMenu} className="btn">Contacto</a>
            </div>
        </div>
    );
}
